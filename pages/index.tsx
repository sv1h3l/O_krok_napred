    ...
    return (
        <>
            ...
            <main className="p-3 max-w-7xl mx-auto">
                    ...
                    {tips.map((tip, index) => (
                        ...
                        >
                            <div className="flex flex-col md:flex-row">
                                <h2 className="bg-[#1e8fdb] text-lg  w-full md:w-fit rounded-t-md md:rounded-tr-none md:rounded-br-md py-2 px-3  md:mb-0 md:-mr-1 text-white z-10 font-light">{tip.title}</h2>
                                <h2 className="bg-[#c7f2ff] border text-lg  w-full md:w-fit  md:rounded-tr-none md:rounded-br-md  py-2 pr-3 pl-3 md:pl-4  z-0">{tip.subtitle}</h2>
                            </div>
                ...
                <footer className="mt-3 px-4 py-3 bg-[#c7f2ff] border rounded-md">
                    <p>
